...
"document" in self && ("classList" in document.createElement("_") ? function() {
    ...
    function() {
        ...
        var i = plyr.setup({
            debug: !0,
            title: "",
            iconUrl: "http://192.168.56.101/images/plyr.svg",
            tooltips: {
                controls: !0
            },
            captions: {
        ...
        plyr.loadSprite("http://192.168.56.101/images/demo.svg");
    ...
    }(window, document, "script", 0, "ga"), ga("create", "", "auto"), ga("send", "pageview"));
    ...
    $('.app-specific').toggleClass('vis') 
     
    });

    $('.nav-three-b').on('click', function () {
    $('.app-global').toggleClass('vis') 
